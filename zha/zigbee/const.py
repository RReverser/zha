"""Shared Zigbee constants used by ZHA runtime and handlers."""

from typing import Final

REPORT_CONFIG_ATTR_PER_REQ: Final[int] = 3
REPORT_CONFIG_ATTR: Final[str] = "attr"
REPORT_CONFIG_CONFIG: Final[str] = "config"
...
CLUSTER_INOVELLI = "inovelli_vzm31sn_cluster"
...
CLUSTER_EVENT: Final[str] = "cluster_handler_event"
CLUSTER_ATTRIBUTE_UPDATED: Final[str] = "cluster_handler_attribute_updated"
CLUSTER_STATE_CHANGED: Final[str] = "cluster_handler_state_changed"
CLUSTER_LEVEL_CHANGED: Final[str] = "cluster_handler_level_changed"
