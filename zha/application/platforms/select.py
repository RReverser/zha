...
class DefaultToneSelectEntity(NonZCLSelectEntity):
    ...
    _cluster_match = ClusterMatch(in_clusters=frozenset({CLUSTER_HANDLER_IAS_WD}))
...
class StartupOnOffSelectEntity(ZCLEnumSelectEntity):
    ...
    _cluster_match = ClusterMatch(in_clusters=frozenset({CLUSTER_HANDLER_ON_OFF}))
...
class InovelliOutputModeEntity(ZCLEnumSelectEntity):
    ...
    _cluster_match = ClusterMatch(in_clusters=frozenset({CLUSTER_HANDLER_INOVELLI}))
...
class SonoffPresenceDetectionSensitivity(ZCLEnumSelectEntity):
    ...
    _cluster_match = ClusterMatch(
        in_clusters=frozenset({CLUSTER_HANDLER_OCCUPANCY}),
...
class KeypadLockout(ZCLEnumSelectEntity):
    ...
    REPORT_CONFIG = {}
    ZCL_INIT_ATTRS = {
        UserInterface.ep_attribute: {
            UserInterface.AttributeDefs.keypad_lockout.name: True,
    ...
    _cluster_match = ClusterMatch(in_clusters=frozenset({"thermostat_ui"}))
...
class DanfossViewingDirection(ZCLEnumSelectEntity):
    ...
    _cluster_match = ClusterMatch(
        in_clusters=frozenset({"thermostat_ui"}),
        exposed_features=frozenset({DANFOSS_ALLY_THERMOSTAT}),
    )
